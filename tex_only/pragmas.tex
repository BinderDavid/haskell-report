...
syntax is \mbox{\tt {\char'173}-{\char'43}} \mbox{\tt {\char'43}-{\char'175}}.

\section{Inlining}
\index{inlining}
\begin{flushleft}\it\begin{tabbing}
\hspace{0.6in}\=\hspace{3.1in}\=\kill
$\it decl$\>\makebox[3.5em]{$\rightarrow$}$\it \makebox{\tt {\char'173}-{\char'43}}\ \makebox{\tt INLINE}\ qvars\ \makebox{\tt {\char'43}-{\char'175}}$\\ 
$\it decl$\>\makebox[3.5em]{$\rightarrow$}$\it \makebox{\tt {\char'173}-{\char'43}}\ \makebox{\tt NOINLINE}\ qvars\ \makebox{\tt {\char'43}-{\char'175}}$
...
The \mbox{\tt INLINE} pragma instructs the compiler to inline the specified variables
at their use sites.
Compilers will often automatically inline simple expressions.  This
may be prevented by the \mbox{\tt NOINLINE} pragma.

\section{Specialization}
\begin{flushleft}\it\begin{tabbing}
\hspace{0.6in}\=\hspace{3.1in}\=\kill
$\it decl$\>\makebox[3.5em]{$\rightarrow$}$\it \makebox{\tt {\char'173}-{\char'43}}\ \makebox{\tt SPECIALIZE}\ spec_1\ \makebox{\tt ,}\ \ldots \ \makebox{\tt ,}\ spec_k\ \makebox{\tt {\char'43}-{\char'175}}$\>\makebox[3em]{}$\it (k\geq 1)$\\ 
$\it spec$\>\makebox[3.5em]{$\rightarrow$}$\it vars\ ::\ type$
\end{tabbing}\end{flushleft}
...
\end{verbatim}}
\eprog
calls to \mbox{\tt factorial} in which the compiler can detect that the
parameter is either \mbox{\tt Int} or \mbox{\tt Integer} will
use specialized versions of \mbox{\tt factorial} which do not involve
...
The \mbox{\tt LANGUAGE} pragma is a file-header pragma. A file-header pragma must
...
keyword \mbox{\tt LANGUAGE} and is followed by a comma-separated list of named
language features.
...
support the \mbox{\tt LANGUAGE} pragma are required to support
\bprog
{\small\begin{verbatim}
