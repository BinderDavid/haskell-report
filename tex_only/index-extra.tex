...
% indexing of the code in the prelude (Chapter A), and the
...
\index{datatype!declaration|see{{\tt data} declaration}}
\index{datatype!recursive|see{recursive datatype}}
\index{datatype!renaming|see{{\tt newtype} declaration}}
\index{declaration!datatype|see{{\tt data} declaration}}
\index{declaration!class|see{class declaration}}
\index{declaration!instance|see{instance declaration}}
\index{declaration!default|see{{\tt default} declaration}}
...
\index{"@-pattern@{\tt {\char'100}}|see{as-pattern}}
\index{_@{\tt {\char'137}}|see{wildcard pattern}}
\index{pattern!"@-pattern@{\tt {\char'100}}|see{as-pattern}}
\index{pattern!_@{\tt {\char'137}}|see{wildcard pattern}}
...
\index{type renaming|see{{\tt newtype} declaration}}
